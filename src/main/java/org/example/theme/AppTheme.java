...
// Immutable theme descriptor.  Holds all the colors used by the UI
public class AppTheme {
    ...
    public Color getChartPrimaryColor()   { return chartPrimaryColor; }
    ...
    public Color getAccentGradientLight() { return lighten(accentColor, 0.2f); }
    public Color getAccentGradientDark()  { return darken(accentColor, 0.2f); }
    public Color[] getChartColors() {
        return new Color[]{
                chartPrimaryColor,
                accentColor,
                lighten(chartPrimaryColor, 0.20f),
                darken(chartPrimaryColor,  0.20f),
                lighten(accentColor,       0.20f),
                darken(accentColor,        0.20f),
